            ...
            <div className=" lg:flex-row lg:items-center lg:justify-between gap-8">
              ...
              <div className="flex-1 max-w-xl lg:max-w-2xl order-2 lg:order-1 text-left">
                <Text variant="body" weight="regular" >
                  El uso del sitio web www.sosencontrandomascotas.com (en lo sucesivo denominado 
            "S.O.S. Encontrando Mascotas") y sus servicios se rigen por los siguientes términos y condiciones.
                </Text>
              </div>
            </div>
          </div>
